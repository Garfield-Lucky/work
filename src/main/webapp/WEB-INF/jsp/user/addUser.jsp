...
<form name="form" id="form" method="post" class="layui-form" action="${pageContext.request.contextPath }/user/addUser" onsubmit="return ajaxSave(this);">
    <table class="layui-table" width="100%">
        <tr>
            <th colspan="2" align="left">添加人员信息</th>
        </tr>
        <tr>
            <td class="left" >账号:</td>
            <td class="right">
                <input type="text" id="userName" name="userName" class="layui-input" required />
            </td>
        </tr>
        <tr>
            <td class="left" >密码:</td>
        ...
        <tr>
            ...
            <td class="right">
                <input type="text" id="trueName" name="trueName" class="layui-input" required />
            </td>
        </tr>
        <tr>
            <td class="left"  >年龄:</td>
        ...
        <tr>
            <td class="left"  >微信:</td>
            <td class="right">
                <input type="text" id="wx" name="wx" class="layui-input" required />
            </td>
        </tr>
